...
class IntelligentMemoryRetrievalAlgorithm:
    ...
    def _mock_vector_search(
        ...
        return [
            {
                'text': f"Client filed 1040 for tax year 2023 with AGI of $95,000",
                'score': 0.92,
            ...
            {
                'text': f"Previous consultation about home office deduction eligibility",
                'score': 0.88,
            ...
            {
                'text': f"Client has rental property in California generating $2,400/month",
                'score': 0.85,
