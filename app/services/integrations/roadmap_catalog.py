...
ROADMAP_CATEGORIES: list[dict[str, Any]] = [
    {
        ...
        "tools": [
            ...
            {"id": "lamo", "name": "Lamo", "description": "Generative AI for tough tax research with cited answers."},
            {
                ...
                "description": "Enterprise tax research and compliance.",
            },
        ],
        "status": "planned",
    },
        ...
        "tools": [
            {
                "id": "chatfin",
                "name": "ChatFin",
                "description": "Transaction intelligence vs global tax rules in real time.",
            },
    ...
    },
    {
        ...
        "tools": [
            ...
            {
                "id": "1040scan",
                "name": "1040SCAN (SurePrep)",
                "description": "Scan, organize, assemble tax workpapers.",
            },
            {
                "id": "holistiplan",
                "name": "Holistiplan",
                "description": "OCR and analysis of returns; planning in ~45s.",
            },
    ...
    },
    {
        ...
        "tools": [
            {
                "id": "corvee",
                "name": "Corvee Tax Planning",
                "description": "Tax savings and multi-year strategy modeling.",
            },
        ...
        "tools": [
            {
                ...
                "description": "Single API layer and security for many systems.",
            },
            {
                "id": "cdata",
                "name": "CData Connect AI",
                "description": "QuickBooks (and others) to AI platforms without duplicating data.",
            },
        ],
        "status": "planned",
    },
